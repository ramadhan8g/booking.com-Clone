    ...
    <header className="bg-[#013B94]">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
            <Popover className="relative">
              ...
              <a href="#" className="text-sm font-semibold leading-6 text-[#ffff]">Flights</a>
              <a href="#" className="text-sm font-semibold leading-6 text-[#ffff]">Car Rental</a>
              <a href="#" className="text-sm font-semibold leading-6 text-[#ffff]">Attractions</a>
              <a href="#" className="text-sm font-semibold leading-6 text-[#ffff]" >Flight + Hotel</a>
        </Popover.Group> 
